# Latest Releases for the week 2026-07-20 - 2026-07-27   
## grpc/grpc  
...
### Release notes for vertical-pod-autoscaler-chart-0.11.0  
#### [autoscaler vertical-pod-autoscaler-chart-0.11.0](https://github.com/kubernetes/autoscaler/releases/tag/vertical-pod-autoscaler-chart-0.11.0)  
#### 2026-07-26  
Automatically adjust resources for your workloads  
### Release notes for vertical-pod-autoscaler-1.7.1  
#### [autoscaler vertical-pod-autoscaler-1.7.1](https://github.com/kubernetes/autoscaler/releases/tag/vertical-pod-autoscaler-1.7.1)  
#### 2026-07-26  
## Changes by Kind
...
- Fixed VPA checkpoint loading to prevent recommendations from restarting from scratch ([#10052](https://github.com/kubernetes/autoscaler/pull/10052), [@adrianmoisey](https://github.com/adrianmoisey))


### Bug

- Fix bug where VPA Checkpoint GC error message wasn't logging correctly ([#9886](https://github.com/kubernetes/autoscaler/pull/9886), [@adrianmoisey](https://github.com/adrianmoisey))
- Add reasons to in-place update deferred log messages ([#9964](https://github.com/kubernetes/autoscaler/pull/9964), [@omerap12](https://github.com/omerap12))

### Other (Cleanup or Flake)

* [vpa-release-1.7] Bump the actions group across 3 directories with 1 update by @k8s-infra-cherrypick-robot in https://github.com/kubernetes/autoscaler/pull/9735
* Bump the patch-updates group across 2 directories with 19 updates by @dependabot[bot] in https://github.com/kubernetes/autoscaler/pull/9776
* Bump the patch-updates group across 2 directories with 37 updates by @dependabot[bot] in https://github.com/kubernetes/autoscaler/pull/9938
* Bump the actions group across 3 directories with 1 update by @dependabot[bot] in https://github.com/kubernetes/autoscaler/pull/9979
* Bump the patch-updates group across 2 directories with 3 updates by @dependabot[bot] in https://github.com/kubernetes/autoscaler/pull/9982
* Bump to k8s 1.36.3 patch versions by @adrianmoisey in https://github.com/kubernetes/autoscaler/pull/10046
* Bump VPA to 1.7.1 by @adrianmoisey in https://github.com/kubernetes/autoscaler/pull/10053
* Bump to VPA 1.7.1 by @adrianmoisey in https://github.com/kubernetes/autoscaler/pull/10058



**Full Changelog**: https://github.com/kubernetes/autoscaler/compare/vertical-pod-autoscaler-1.7.0...vertical-pod-autoscaler-1.7.1  
